...
export function ProjectCard({ project, featured = false }: { project: Project; featured?: boolean }) {
  return (
    <a
      ...
      className={`group flex h-full flex-col rounded-xl border border-zinc-200/80 bg-white/70 shadow-sm transition duration-200 hover:-translate-y-1 hover:border-zinc-400 hover:shadow-soft dark:border-white/10 dark:bg-white/[0.035] dark:hover:border-[#1db954]/60 ${
